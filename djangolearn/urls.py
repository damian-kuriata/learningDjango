...
from djangolearn.views import LearnView, ManageLanguagesView, LanguageView, ManagePhrasesView, LearningLanguageView
...
urlpatterns = [
    ...
    re_path(r"^api/learning-language/((?P<language>\w+)/)?$", csrf_exempt(LearningLanguageView.as_view()), name="learning-language"),
    re_path(r"^manage-phrases/((?P<id>\d+)/)?$", ManagePhrasesView.as_view(), name="manage-phrases")
